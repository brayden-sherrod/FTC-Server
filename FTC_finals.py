...
# Team listings
def get_team_names(eventcode, teamNums):
    # teamNumber=14361
...
def get_match_team_nums(eventcode, level, matchList=pd.DataFrame, teamNums=[]):
    ...
    for match in m.json().get("schedule"):
        ...
        if matchNum in matchList['Match']:
...
# Alliance 3:
# Alliance 4:
jemison_teams = [14631, 1762, 11260, 15534, 6272, 16417, 18225, 1412, 14503, 22508, 14140, ]
